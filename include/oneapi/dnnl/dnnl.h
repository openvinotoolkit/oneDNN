...
dnnl_status_t DNNL_API dnnl_primitive_attr_get_output_compensations(
        const_dnnl_primitive_attr_t attr, int *count, int *mask,
...
dnnl_status_t DNNL_API dnnl_post_ops_append_dw_conv(dnnl_post_ops_t post_ops,
        ...
        dnnl_data_type_t in_dt, const float *weights_data,
...
dnnl_status_t DNNL_API dnnl_post_ops_append_quantization(
        dnnl_post_ops_t post_ops, dnnl_alg_kind_t alg, const void *crop_low,
