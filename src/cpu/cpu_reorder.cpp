...
using spec_conv_s8s8 = spec::conv_s8s8;
...
const impl_list_map_t regular_impl_list_map {
    ...
    {{f32, f32, 4}, {
        DNNL_X64_ONLY(REG_REORDER_FN(x64_wino_reorder_t, f32, f32))
    ...
    // f32 -> s8
    {{f32, s8, 0}, {
        DNNL_X64_ONLY(REG_REORDER_FN(x64_wino_reorder_t, f32, s8))
...
//        REG_FAST_DIRECT_COPY_COMMA(f32, u8)
    ...
    {{s8, data_type::undef, 0}, {
        REG_REORDER_FN(rnn_weights_reorder_s8_t, s8)
...
const impl_list_map_t comp_s8s8_impl_list_map {
    ...
    {{f32, s8, 3}, {
        ...
        REG_SR(f32, oiw, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wio, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oiw, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wio, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oiw, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wio, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{f32, s8, 4}, {
        REG_SR(f32, any, s8, hwio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, any, s8, wigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, gOIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, gOIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oihw, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwio, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwio, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oihw, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwio, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oihw, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, Goiw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, Goiw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goiw, s8, Goiw4g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, wigo, s8, Goiw4g, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{f32, s8, 5}, {
        REG_SR(f32, any, s8, hwigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, any, s8, dhwio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, gOIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, gOIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oidhw, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, dhwio, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oidhw, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, dhwio, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, oidhw, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, dhwio, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, Goihw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, Goihw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goihw, s8, Goihw4g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, hwigo, s8, Goihw4g, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{f32, s8, 6}, {
        REG_SR(f32, any, s8, dhwigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goidhw, s8, gOIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goidhw, s8, gOIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(f32, goidhw, s8, gOIdhw4o4i, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    // bf16 -> s8
    {{bf16, s8, 3}, {
        REG_SR(bf16, any, s8, wio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oiw, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wio, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oiw, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wio, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oiw, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wio, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{bf16, s8, 4}, {
        REG_SR(bf16, any, s8, hwio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, any, s8, wigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, gOIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, gOIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oihw, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwio, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwio, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oihw, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwio, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oihw, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, Goiw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, Goiw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goiw, s8, Goiw4g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, wigo, s8, Goiw4g, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{bf16, s8, 5}, {
        REG_SR(bf16, any, s8, hwigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, any, s8, dhwio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, gOIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, gOIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oidhw, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, dhwio, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oidhw, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, dhwio, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, oidhw, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, dhwio, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, Goihw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, Goihw8g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goihw, s8, Goihw4g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, hwigo, s8, Goihw4g, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    {{bf16, s8, 6}, {
        REG_SR(bf16, any, s8, dhwigo, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goidhw, s8, gOIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goidhw, s8, gOIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(bf16, goidhw, s8, gOIdhw4o4i, fmt_order_keep, spec_conv_s8s8)

        nullptr,
    }},
    // s8 -> s8
    {{s8, s8, 3}, {
        REG_SR(s8, any, s8, wio, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oiw, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wio, s8, OIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oiw, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wio, s8, OIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oiw, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wio, s8, OIw4o4i, fmt_order_keep, spec_conv_s8s8)
    ...
    {{s8, s8, 4}, {
        ...
        REG_SR(s8, wigo, s8, gOIw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goiw, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wigo, s8, gOIw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goiw, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wigo, s8, gOIw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwio, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oihw, s8, OIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwio, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oihw, s8, OIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwio, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oihw, s8, OIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goiw, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, wigo, s8, Goiw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goiw, s8, Goiw8g, fmt_order_keep, spec_conv_s8s8)
    ...
    {{s8, s8, 5}, {
        ...
        REG_SR(s8, hwigo, s8, gOIhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goihw, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwigo, s8, gOIhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goihw, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwigo, s8, gOIhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oidhw, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, dhwio, s8, OIdhw4i16o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oidhw, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, dhwio, s8, OIdhw2i8o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, oidhw, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, dhwio, s8, OIdhw4o4i, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goihw, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, hwigo, s8, Goihw16g, fmt_order_keep, spec_conv_s8s8)
        REG_SR(s8, goihw, s8, Goihw8g, fmt_order_keep, spec_conv_s8s8)
