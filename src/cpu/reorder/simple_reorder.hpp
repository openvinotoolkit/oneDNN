            ...
            for (int cb = 0; cb < utils::div_up(c_block, 4); ++cb) {
                for (int b = 0; b < b_block; ++b) {
                    ...
                    for (int c = 0; c < c_int_block; ++c) {
                        ...
                        uint8_t dst_val = c == 0 ? 0 : output_val[oidx / 4];
