...
status_t post_ops_t::append_quantization(alg_kind_t alg,
    ...
    auto input_scale_data = reinterpret_cast<const rnn_create_time_scales_t*>(input_scale);
    auto input_shift_data = reinterpret_cast<const shifts_t<float>*>(input_shift);
    auto output_scale_data = reinterpret_cast<const rnn_create_time_scales_t*>(output_scale);
