...
if [[ "$OS" == "Linux" ]]; then
    ...
    SKIPPED_TEST_FAILURES+="|test_graph_unit_dnnl_bmm_cpu"
    SKIPPED_TEST_FAILURES+="|test_graph_unit_dnnl_convolution_cpu"
    SKIPPED_TEST_FAILURES+="|test_graph_unit_dnnl_large_partition_cpu"
    SKIPPED_TEST_FAILURES+="|test_graph_unit_dnnl_matmul_cpu"
    SKIPPED_TEST_FAILURES+="|test_graph_unit_dnnl_pool_cpu"
    ...
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_conv_ci_cpu"
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_deconv_ci_cpu"
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_eltwise_ci_cpu"
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_matmul_ci_cpu"
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_matmul_sparse_ci_cpu"
    SKIPPED_TEST_FAILURES+="|test_benchdnn_modeC_pool_ci_cpu"
elif [[ "$OS" == "Darwin" ]]; then
    SKIPPED_TEST_FAILURES+="|cpu-matmul-coo-cpp"
    SKIPPED_TEST_FAILURES+="|cpu-matmul-csr-cpp"
    SKIPPED_TEST_FAILURES+="|cpu-tutorials-matmul-sgemm-and-matmul-cpp"
